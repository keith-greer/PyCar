...
# Sets screen dimensions based on the "size" variable above
...
car_loc.center = int(right_lane), int(height * 0.8)
...
enemy_car_loc.center = int(left_lane), int(height * 0.2)
...
while running:
    ...
    # Dynamic animation for the enemy car within the loop
    enemy_car_loc.y += 1
    if enemy_car_loc.y > height:
        enemy_car_loc.y = -enemy_car_height  # Reset position when off the bottom
